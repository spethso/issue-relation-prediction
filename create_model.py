    ...
    def __getitem__(self, idx):
        ...
        return {
            "input_ids": torch.tensor(
                issue_relation_pair_encoded["input_ids"], dtype=torch.long
            ),
            "attention_mask": torch.tensor(
                issue_relation_pair_encoded["attention_mask"], dtype=torch.long
            ),
            "token_type_ids": torch.tensor(
                issue_relation_pair_encoded["token_type_ids"], dtype=torch.long
            ),
            "label": torch.tensor(issue_pair_relation_tupel[2], dtype=torch.long),
        }
